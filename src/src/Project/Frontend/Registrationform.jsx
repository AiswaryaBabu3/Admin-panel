...
export default function Form() {
  ...
  const isPasswordValid = (password) => {
    // Password should have minimum 8 characters, at least one uppercase letter, one lowercase letter, one digit, and one special character
    ...
    <div>
      <Container className="form-container">
        ...
        <form className="form-wrapper" onSubmit={handleSubmit(onSubmit)}>
          ...
          <br />
            ...
            <input
              ...
              {...register("Password", {
                ...
                validate: (value) => isPasswordValid(value) || "Invalid password format",
              })}
          ...
          <Button type="submit" className="submit-formbutton">
            SUBMIT
          </Button>
        </form>
      </Container>
